...
$query_users = "SELECT B.nm_bagian, U.* FROM tbl_bagian B, tbl_user U WHERE U.id_bagian = B.id_bagian ORDER BY U.id_user DESC";
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="user-edit.php?id=<?php echo $row_users["id_user"] ?>" class="text-light bg-success border-0"><i class='bx bxs-edit'></i></a>
                                                    <a href="user-hapus.php?id=<?php echo $row_users["id_user"] ?>" class="ms-4 text-light bg-warning border-0" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
                                                    <a href="user-reset.php?id=<?php echo $row_users["id_user"] ?>" class="ms-4 text-light bg-info border-0" onClick="return confirm('Password akan direset menjadi default : admin...?')"><i class='lni lni-reload'></i></a>

                                                </div>
                                            </td>
                                            <td>
                                                <?php if ($row_users["level"] == 1) { ?>
                                                    <span class="badge bg-light-danger text-danger w-100">Super Admin</span>
                                                <?php } else if ($row_users["level"] == 2) { ?>
                                                    <span class="badge bg-light-warning text-warning w-100">Admin</span>
                                                <?php } else if ($row_users["level"] == 3) { ?>
                                                    <span class="badge bg-light-success text-success w-100">User</span>
                                                <?php } else if ($row_users["level"] == 4) { ?>
                                            ...
                                            <td><?php echo $row_users["nm_bagian"] ?></td>
                                            <td>
