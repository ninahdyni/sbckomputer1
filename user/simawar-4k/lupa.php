...
if (isset($_POST["submit"])) {
    ...
    $query_nik = "SELECT nik FROM tbl_user WHERE nik = '$nik'";
    ...
    $query_telp = "SELECT telp FROM tbl_user WHERE telp = '$telp'";
    ...
    $query_email = "SELECT email FROM tbl_user WHERE email = '$email'";
    ...
    $query_reset = "UPDATE tbl_user SET password = '$password' WHERE nik = '$nik'";
