...
$query_srt_msk = "SELECT * FROM tbl_srt_msk ORDER BY id_srt_msk DESC";
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="srt-msk-edit.php?id=<?php echo $row_srt_msk["id_srt_msk"] ?>" class="text-light bg-success border-0"><i class='bx bxs-edit'></i></a>
                                                    <a href="srt-msk-hapus.php?id=<?php echo $row_srt_msk["id_srt_msk"] ?>" class="ms-4 text-light bg-warning border-0" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
