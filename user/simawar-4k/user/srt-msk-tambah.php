...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO tbl_srt_msk VALUES (NULL, '$no_srt', '$tgl_srt', '$nik', '$hal', '$dari', '$file', '$tgl_terima', '$penerima')";
...
<head>
    ...
    <title>Simawar - Upload Surat Masuk</title>
</head>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Upload Surat Masuk</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body px-5 pb-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Upload Surat Masuk</h5>
                                </div>
                                <hr>
                                <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                                    <div class="col-12">
                                        <label for="no_srt" class="form-label">Nomor Surat :</label>
                                        <input type="text" class="form-control" name="no_srt" id="no_srt" placeholder="Nomor Surat Masuk" required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="lampiran" id="lampiran" placeholder="Lampiran" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="hal" class="form-label">Perihal :</label>
                                        <input type="text" class="form-control" name="hal" id="hal" placeholder="Perihal" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="dari" class="form-label">Dari :</label>
                                        <input type="text" class="form-control" name="dari" id="dari" placeholder="Surat Dari" required>
                                    </div>
                                    ...
                                    <input type="hidden" name="tgl_terima" value="<?php echo date("Y-m-d H:i:s") ?>">
                                    <input type="hidden" name="penerima" value="<?php echo $row_user["nm_user"] ?>">
