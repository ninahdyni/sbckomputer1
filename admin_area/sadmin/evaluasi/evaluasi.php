                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="evaluasi-hapus.php?id=<?php echo $row_evaluasi["id_evaluasi"] ?>" class="ms-4 text-light bg-warning border-0" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
                                                </div>
                                            </td>
