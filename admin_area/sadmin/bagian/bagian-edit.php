...
$query_bagian = "SELECT * FROM bagian WHERE id_bagian = $id_bagian";
...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE bagian SET nm_bagian = '$nm_bagian' WHERE id_bagian = $id_bagian";
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xl-12 mx-auto">
                        <h6 class="mb-0 text-uppercase">Edit Bagian</h6>
                        <hr />
                            ...
                            <div class="card-body px-5 pb-5">
                                ...
                                <form class="row g-3" method="POST" target="">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="nm_bagian" id="nm_bagian" value="<?php echo $row_bagian["nm_bagian"] ?>" placeholder="Nama Bagian" required>
                                    </div>
