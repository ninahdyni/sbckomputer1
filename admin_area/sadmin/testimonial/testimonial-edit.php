...
$query_users = "SELECT * FROM testimonial WHERE id_testi = $id_users";
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body px-5 pb-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Update Data Testimonial</h5>
                                </div>
                                <hr>
                                <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea type="textarea" class="form-control" rows="5" name="komentar" id="komentar" placeholder="Komentar" required><?php echo $row_users["komentar"] ?></textarea>
                                    </div>
