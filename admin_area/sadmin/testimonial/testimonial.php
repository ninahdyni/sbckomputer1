...
<head>
    ...
    <title>Simawar - Data Testimonial</title>
</head>
    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <!--end breadcrumb-->
                <h5 class="my-4 text-uppercase">Data Testimonial</h5>
                <div class="col">
                    <!-- <a href="testimonial-tambah.php" class="btn btn-primary"><i class='bx bx-plus mr-1'></i>Tambah Data</a>
                    -->
                </div>
                <hr />
                <div class="card">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <!-- <a href="testimonial-edit.php?id=<?php echo $row_testimonial["id_testi"] ?>" class="text-light bg-success border-0"><i class='bx bxs-edit'></i></a>
                                                        -->
                                                    <a href="testimonial-hapus.php?id=<?php echo $row_testimonial["id_testi"] ?>" class="ms-4 text-light bg-warning border-0" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
                                                </div>
                                            </td>
                                            <td>
