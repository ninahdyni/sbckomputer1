...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO tbl_admin VALUES (NULL, '$username', '$nm_user', '$nik', '$id_bagian', '$telp', '$email', '$foto', '$password', '$tgl_reg', '$oleh', '$status', '$theme')";
                            ...
                            <div class="card-body px-5 pb-5">
                                ...
                                <form class="row g-3" method="POST" target="">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control" name="nik" id="nik" placeholder="Nomor Induk Kepegawaian" required>
                                    </div>
