...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO promo VALUES (NULL, '$judul', '$id_program', '$kode', '$biaya_promo', '$pesan1', '$pesan2', '$batas', '$terpakai')";
                            ...
                            <div class="card-body px-5 pb-5">
                                ...
                                <form class="row g-3" method="POST" target="">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul Promo" required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="kode" id="kode" placeholder="KODE UNIK HURUF KAPITAL" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="biaya_promo" class="form-label">Biaya Promo :</label>
                                        <input type="text" class="form-control" name="biaya_promo" id="biaya_promo" placeholder="ex: Rp. 1.000.000,00" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="pesan1" class="form-label">Pesan 1 :</label>
                                        <textarea type="textarea" class="form-control" name="pesan1" id="pesan1" placeholder="Pesan Paragraf 1" required></textarea>
                                    </div>

                                    <div class="col-12">
                                        <label for="pesan2" class="form-label">Pesan 2 :</label>
                                        <textarea type="textarea" class="form-control" name="pesan2" id="pesan2" placeholder="Pesan Paragraf 2" required></textarea>
                                    </div>

                                    <div class="col-12">
                                        <label for="batas" class="form-label">Batas Pemakaian :</label>
                                        <input type="number" class="form-control" name="batas" id="batas" placeholder="Batas Pemakaian" required>
                                    </div>
                                    <input type="hidden" name="terpakai" value="0">
                                    <div class="col-12">
